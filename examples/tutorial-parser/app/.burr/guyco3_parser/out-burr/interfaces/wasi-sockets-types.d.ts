...
export class TcpSocket {
  ...
  listen(): AsyncIterable<TcpSocket>;
  send(data: AsyncIterable<number>): PromiseLike<Result<void, ErrorCode>>;
  receive(): [AsyncIterable<number>, PromiseLike<Result<void, ErrorCode>>];
