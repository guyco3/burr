"use components";
import { getEnvironment } from '../burr_shim.js';
...
_trampoline12.fnName = 'wasi:cli/environment@0.3.0#getEnvironment';
...
_trampoline16.fnName = 'wasi:cli/environment@0.2.6#getEnvironment$1';
...
let exports1ParseUppercase;

function parseUppercase(arg0) {
  
  var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
  var ptr0= encodeRes.ptr;
  var len0 = encodeRes.len;
  
  _debugLog('[iface="parse-uppercase", function="parse-uppercase"][Instruction::CallWasm] enter', {
    funcName: 'parse-uppercase',
    paramCount: 2,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    entryFnName: 'exports1ParseUppercase',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1ParseUppercase(ptr0, len0),
    });
  } catch (err) {
  ...
  _debugLog('[iface="parse-uppercase", function="parse-uppercase"][Instruction::Return]', {
    funcName: 'parse-uppercase',
    paramCount: 1,
    async: false,
    postReturn: true
...
function countWords(arg0) {
  ...
  _debugLog('[iface="count-words", function="count-words"][Instruction::CallWasm] enter', {
    funcName: 'count-words',
    paramCount: 2,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1CountWords',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1CountWords(ptr0, len0),
    });
  } catch (err) {
  ...
  _debugLog('[iface="count-words", function="count-words"][Instruction::Return]', {
    funcName: 'count-words',
    paramCount: 1,
    async: false,
    postReturn: false
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    postReturn0 = exports1['cabi_post_parse-uppercase'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_parse-uppercase']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_parse-uppercase'];
    }
    
    exports1ParseUppercase = exports1['parse-uppercase'];
    exports1CountWords = exports1['count-words'];
  })();
...
export { countWords, parseUppercase,  }
export const _util = {
