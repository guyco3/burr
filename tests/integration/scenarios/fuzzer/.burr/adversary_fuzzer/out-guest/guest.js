if (!WebAssembly.Suspending) { WebAssembly.Suspending = class { constructor(fn) { return fn; } }; }
if (!WebAssembly.promising) { WebAssembly.promising = function(fn) { return fn; }; }
"use components";
import { Descriptor, getDirectories, getEnvironment } from '../burr_shim.js';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module1 = fetchCompile(new URL('./guest.core2.wasm', import.meta.url));
    const module2 = fetchCompile(new URL('./guest.core3.wasm', import.meta.url));
