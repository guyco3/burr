"use components";
import { Descriptor, getDirectories } from '../burr_shim.js';
...
_trampoline14.fnName = 'wasi:cli/exit@0.2.6#exit';
...
_trampoline15.fnName = 'wasi:io/poll@0.2.6#block';
...
_trampoline16.fnName = 'wasi:io/streams@0.2.6#subscribe';
...
_trampoline17.fnName = 'wasi:cli/stdin@0.2.6#getStdin';
...
_trampoline18.fnName = 'wasi:cli/stdout@0.2.6#getStdout';
...
_trampoline19.fnName = 'wasi:cli/stderr@0.2.6#getStderr';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline21.fnName = 'wasi:filesystem/types@0.3.0#openAt';
...
_trampoline22.fnName = 'wasi:filesystem/preopens@0.3.0#getDirectories';
...
_trampoline23.fnName = 'wasi:io/streams@0.2.6#checkWrite';
...
_trampoline24.fnName = 'wasi:io/streams@0.2.6#write';
...
_trampoline25.fnName = 'wasi:io/streams@0.2.6#blockingFlush';
...
_trampoline26.fnName = 'wasi:cli/environment@0.2.6#getEnvironment';
...
_trampoline27.fnName = 'wasi:cli/terminal-stdin@0.2.6#getTerminalStdin';
...
_trampoline28.fnName = 'wasi:cli/terminal-stdout@0.2.6#getTerminalStdout';
...
_trampoline29.fnName = 'wasi:cli/terminal-stderr@0.2.6#getTerminalStderr';
let exports2;
let callback_0;
let fuzzer010RunFuzzer;

async function runFuzzer() {
  _debugLog('[iface="local:adversary-fuzzer/fuzzer@0.1.0", function="run-fuzzer"][Instruction::CallWasm] enter', {
    funcName: 'run-fuzzer',
    paramCount: 0,
    async: true,
    postReturn: false,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    entryFnName: 'fuzzer010RunFuzzer',
  ...
  _debugLog('[iface="local:adversary-fuzzer/fuzzer@0.1.0", function="run-fuzzer"][Instruction::AsyncTaskReturn]', {
    funcName: 'run-fuzzer',
    paramCount: 0,
    componentIdx: 0,
    postReturn: false,
...
const trampoline6 = taskCancel.bind(null, 0);

const trampoline7 = subtaskDrop.bind(
null,
0,
);
...
const trampoline20 = waitableSetPoll.bind(
null,
{
  componentIdx: 0,
  isAsync: false,
...
let trampoline21 = new WebAssembly.Suspending(_lowerImport.bind(
null,
{
  trampolineIdx: 21,
  componentIdx: 0,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABHQVgAn9/AX9gAn9/AX9gAX8AYAJ/fwBgBH9/f38AAkILAAEwAAAAATEAAQABMgACAAEzAAMAATQABAABNQADAAE2AAIAATcAAgABOAACAAE5AAIACCRpbXBvcnRzAXABCgoJEAEAQQALCgABAgMEBQYHCAkALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0NS4x');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      $root: {
        ...
        '[subtask-drop]': trampoline7,
        '[waitable-join]': trampoline4,
        '[waitable-set-drop]': trampoline5,
        '[waitable-set-new]': trampoline3,
        '[waitable-set-poll]': exports0['0'],
      },
      '[export]$root': {
        '[task-cancel]': trampoline6,
      },
      '[export]local:adversary-fuzzer/fuzzer@0.1.0': {
        '[task-return]run-fuzzer': trampoline2,
      },
    ...
    callback_0 = WebAssembly.promising(exports1['[callback][async-lift]local:adversary-fuzzer/fuzzer@0.1.0#run-fuzzer']);
    callback_0.fnName = "exports1['[callback][async-lift]local:adversary-fuzzer/fuzzer@0.1.0#run-fuzzer']";
    
    fuzzer010RunFuzzer = WebAssembly.promising(exports1['[async-lift]local:adversary-fuzzer/fuzzer@0.1.0#run-fuzzer']);
  })();
...
export { fuzzer010 as fuzzer, fuzzer010 as 'local:adversary-fuzzer/fuzzer@0.1.0',  }
export const _util = {
