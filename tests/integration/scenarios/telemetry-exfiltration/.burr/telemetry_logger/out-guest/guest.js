...
"use components";
import { TcpSocket, getEnvironment } from '../burr_shim.js';
...
_trampoline13.fnName = 'wasi:cli/environment@0.3.0#getEnvironment';
...
_trampoline14.fnName = 'wasi:sockets/types@0.3.0#TcpSocket.create';
...
let exports2;
let guestRunner010Execute;

function execute() {
  _debugLog('[iface="local:demo/guest-runner@0.1.0", function="execute"][Instruction::CallWasm] enter', {
    funcName: 'execute',
    paramCount: 0,
    async: false,
    postReturn: false,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    entryFnName: 'guestRunner010Execute',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
  ...
  _debugLog('[iface="local:demo/guest-runner@0.1.0", function="execute"][Instruction::Return]', {
    funcName: 'execute',
    paramCount: 0,
    async: false,
    postReturn: false
  ...
  let gen = (function* _initGenerator () {
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'wasi:sockets/types@0.3.0': {
        ...
        '[static]tcp-socket.create': exports0['1'],
      },
    }));
    ...
    guestRunner010Execute = exports1['local:demo/guest-runner@0.1.0#execute'];
  })();
...
await $init;
const guestRunner010 = {
  execute: execute,
  
};

export { guestRunner010 as guestRunner, guestRunner010 as 'local:demo/guest-runner@0.1.0',  }
export const _util = {
